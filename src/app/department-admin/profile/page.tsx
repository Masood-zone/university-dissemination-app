		...
		<>
			...
			>
				<DialogContent className="max-w-lg">
					...
					<DialogFooter className="gap-2 sm:gap-0">
						...
						<Button type="button" disabled={saveDisabled} onClick={() => void handleSaveProfile()}>
							Save changes
						</Button>
					</DialogFooter>
				</DialogContent>
			...
			>
				<DialogContent className="max-w-lg">
					...
					<DialogFooter className="gap-2 sm:gap-0">
						<DialogClose asChild>
							<Button type="button" variant="secondary" disabled={passwordDisabled}>
								Cancel
							</Button>
						</DialogClose>
						<Button type="button" disabled={passwordDisabled} onClick={() => void handleChangePassword()}>
							Update password
						</Button>
					</DialogFooter>
				</DialogContent>
