  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 bg-background relative overflow-hidden">
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-25 dark:opacity-40 bg-[radial-gradient(circle_at_25%_25%,var(--brand-burgundy)_0%,transparent_45%),radial-gradient(circle_at_80%_70%,var(--brand-navy)_0%,transparent_45%)]" />
      </div>
