...
interface StudentEnrollmentSubmittedEmailProps {
  studentEmail: string;
  studentName?: string;
...
export function StudentEnrollmentSubmittedEmail({
  studentEmail,
  studentName,
  applicationNo,
  portalUrl,
  temporaryPassword,
}: StudentEnrollmentSubmittedEmailProps) {
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={content}>
            <Text style={heading}>Enrollment submitted</Text>
            <Text style={paragraph}>Hello {studentName || studentEmail},</Text>

            <Text style={paragraph}>
              We&apos;ve received your enrollment application. Your application
