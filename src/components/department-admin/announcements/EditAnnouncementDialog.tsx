...
import {
  useDepartmentAdminAnnouncementDetail,
  useDepartmentAdminUpdateAnnouncement,
...
export default function EditAnnouncementDialog({
  ...
  const detailQuery = useDepartmentAdminAnnouncementDetail(
    open ? announcementId : null,
  );
  const updateMutation = useDepartmentAdminUpdateAnnouncement();
