...
import { useDepartmentAdminAnnouncementDetail } from "@/services/department-admin/announcement/announcement";
...
export default function AnnouncementDetailClient({ id }: { id: string }) {
  ...
  const detailQuery = useDepartmentAdminAnnouncementDetail(id);
